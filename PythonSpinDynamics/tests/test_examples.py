...
class ExampleSmokeTests(unittest.TestCase):
    ...
    def test_non_plot_examples_run(self) -> None:
        commands = [
            ...
            (
                "examples/large_isochromat_backends.py",
                "--numpts",
                "2001",
                "--num-echoes",
                "4",
            ...
            (
                "examples/refocusing_gradient_optimization.py",
                "--segments",
                "4",
                "--starts",
                "2",
    ...
    def test_plot_examples_expose_cli_without_matplotlib(self) -> None:
        ...
        result = run_example("examples/plot_esr_eseem_hyscore.py", "--help")
        self.assertIn("--pseudosecular-mhz", result.stdout)
        self.assertIn("--hyscore-step-ns", result.stdout)
